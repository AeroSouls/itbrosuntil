...
$inputXML = '<Window x:Class="WinUtility.MainWindow"
        ...
        Title="ITBros Windows Utility" Height="800" Width="1200">
                    ...
                    <TabItem Header="Install" Visibility="Collapsed" Name="WPFTab1">
                        <Grid Background="Transparent">
                            ...
                            <StackPanel Background="{MainBackgroundColor}" SnapsToDevicePixels="True" Grid.Row="1" Grid.Column="3" Margin="10">
                                ...
                                <CheckBox Name="WPFInstallhwinfo" Content="All Hardware Info" Margin="5,0"/>
...
$sync.configs.themes = '{
    "Classic":  {
                   ...
                   "ButtonInstallBackgroundColor":  "#03071E",
                   "ButtonTweaksBackgroundColor":  "#370617",
                   "ButtonConfigBackgroundColor":  "#6A040F",
                   "ButtonUpdatesBackgroundColor":  "#9D0208",
                   ...
                   "ButtonBackgroundSelectedColor":  "#FF1D1D",
